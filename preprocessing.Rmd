...
data[40:44] %>% filter_all(any_vars(. %in% 'Yes'))

drug_interactions <- names(data[40:44])
...
```{r}
write.csv(data, "/Users/apgillock/Dropbox/MIS 382N Advanced Machine Learning/Project\\preprocessed.csv", row.names = FALSE)
```

```{r}
data %>% select(diag_1, diag_2, diag_3)
```
